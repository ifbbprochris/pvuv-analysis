...
func makeLog(current , refer, ua string) string {
	...
	logTemplate := "127.0.0.1 - - [28/Nov/2018:14:43:31 +0800] \"OPTIONS /dig?{$paramsStr} HTTP/1.1\" 200 43\"-\" \"{$ua}\" \"-\""
...
func main() {
	total := flag.Int("total",10000,"how many lines")
	filePath := flag.String("filePath","/Users/chris/Public/nginx/logs/dig.log","filePath")
	flag.Parse()
